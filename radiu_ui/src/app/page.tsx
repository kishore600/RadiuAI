            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Start with our free analysis and upgrade when you need more
                  detailed insights
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
                {pricingTiers.map((tier, index) => (
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                    className={`relative rounded-2xl p-8 bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`w-full py-3 rounded-xl font-semibold text-white bg-gradient-to-r ${tier.color} shadow-lg hover:shadow-xl transition-all duration-300`}
                    >
                      {tier.cta}
                    </motion.button>
              ...
              <motion.div
                ...
                className="text-center mt-12 p-6 bg-yellow-50 border border-yellow-200 rounded-2xl max-w-2xl mx-auto"
              >
                ...
                <p className="text-yellow-700">
                  <span className="font-bold">
                    Only 1 free comprehensive report per day!
                  </span>{" "}
                  Upgrade to unlock unlimited insights and advanced features.
                </p>
              </motion.div>
            </div>
          </section>
