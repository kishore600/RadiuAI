...
export function GoogleMapsPicker({
      ...
      <Alert variant="destructive" className="border-destructive/50">
        ...
        <AlertDescription>
          <div className="space-y-2">
            ...
            <p className="text-xs">
              <strong>Security:</strong> Restrict your API key in Google Cloud
              Console by domain and API scope.
            </p>
          </div>
        </AlertDescription>
      </Alert>
  ...
  return (
    <Card
      className={`${className} border-accent/20 bg-gradient-to-br from-card to-muted/30`}
    >
      <CardContent className="p-6 space-y-4">
        <div className="space-y-3">
          <Label className="flex items-center gap-2 text-base ">
            ...
            <div className="flex flex-col">Location Search</div>
          <p className="text-sm text-gray-500">
            Give you location i will save you 1week analyse effor 😉
          </p>
            </div>
          </Label>
        ...
        <div className="p-4 bg-gradient-to-r from-accent/5 to-primary/5 rounded-lg border border-accent/10">
          ...
          <div className="text-xs text-muted-foreground space-y-1">
            <p>
              • <strong>Click</strong> anywhere on the map to set your analysis
              location
            </p>
            <p>
              • <strong>Drag</strong> the purple marker to fine-tune the exact
              position
            </p>
            <p>
              • <strong>Search</strong> for specific addresses or landmarks
              using the search box
            </p>
            <p>
              • <strong>Current location</strong> button uses your device&apos;s
