...
export function CompetitorAnalysis({ data }: CompetitorAnalysisProps) {
  ...
  const displayedCompetitors = showAll ? competitors : competitors.slice(0, 10);
  ...
  const densityInfo = getDensityLevel(statistics.business_density);
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {data.data.total_competitors} competitors found in the analysis area
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Detailed list of competitors in your area
              </CardDescription>
            </div>
            {competitors.length > 0 && (
              <Badge variant="outline" className="text-xs">
                ...
                >
                  <div className="space-y-1 flex-1">
                    ...
                    <div className="flex items-center gap-4 text-xs text-muted-foreground">
                      ...
                      {competitor.address &&
                        competitor.address !== "Address not specified" && (
